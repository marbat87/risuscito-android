 ...
 */
public class CantoNumericAdapter extends RecyclerView.Adapter implements SectionIndexer {
    ...
    public CantoNumericAdapter(List<CantoRecycled> dataItems
    ...
    private void init() {
        ...
        for (int x = 0; x < size; x++) {
            ...
            int pagina = dataItems.get(x).getPagina();
    ...
    public int getSectionForPosition(int position) {
        int pagina = dataItems.get(position).getPagina();
        String first = String.valueOf(pagina);

...
import it.cammino.risuscito.utils.ResourceHelper;
...
//    private final PendingIntent mNextIntent;
    ...
    private static final String CHANNEL_ID = "ump_media_playback_channel";
...
//        }
        Intent openUI = new Intent(mService, PaginaRenderActivity.class);
        openUI.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);

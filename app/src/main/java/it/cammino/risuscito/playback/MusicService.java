...
import static it.cammino.risuscito.playback.MusicProvider.MEDIA_ID_EMPTY_ROOT;
import static it.cammino.risuscito.playback.MusicProvider.MEDIA_ID_ROOT;
...
public class MusicService extends MediaBrowserServiceCompat {
    ...
    public void onCreate() {
        ...
        Intent intent = new Intent(context, PaginaRenderActivity.class);
...
//    }
    ...
    private void updatePlaybackState(String error) {
        ...
        if (state == PlaybackStateCompat.STATE_PLAYING) {
            MediaMetadataCompat oldMetadataCompat = mMusicProvider.getMusic(mCurrentMedia.getDescription().getMediaId());
            MediaMetadataCompat newMetadataCompat =  new MediaMetadataCompat.Builder()
                    ...
                    .build();
            mMusicProvider.updateMusic(mCurrentMedia.getDescription().getMediaId(), newMetadataCompat);

...
public class ColorChooserDialog extends DialogFragment
    ...
    private Parcelable[] colorsTop;
    @Nullable private Parcelable[][] colorsSub;
    ...
    private Parcelable selectedCustomColor;
    ...
    private void invalidateDynamicButtonColors() {
        ...
        if (builder.dynamicButtonColor) {
            int selectedColor;
            if (isAccentMode())
                selectedColor = ContextCompat.getColor(getContext(), ((AccentColor)getSelectedColor()).getAccentColorRes());
            else
                selectedColor = ContextCompat.getColor(getContext(), ((PrimaryColor)getSelectedColor()).getPrimaryColorRes());
...
//            color = DialogUtils.resolveColor(getActivity(), R.attr.colorAccent, fallback);
            if (isAccentMode())
                color = AccentColor.PINK_A200;
            else
                color = PrimaryColor.INDIGO_500;
        }
        return color;
    }

    private void findSubIndexForColor(int topIndex, Parcelable color) {
        if (colorsSub == null || colorsSub.length - 1 < topIndex) {
            return;
        }
        Parcelable[] subColors = colorsSub[topIndex];
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (getBuilder().setPreselectionColor) {
                ...
                if (isAccentMode())
                    preselectColor = AccentColor.PINK_A200;
                else
                    preselectColor = PrimaryColor.INDIGO_500;
                foundPreselectColor = true;
            }
        }
...
//    }
    ...
    @interface ColorChooserTag {}

    public interface ColorCallback {

        void onColorSelection(@NonNull ColorChooserDialog dialog, Parcelable selectedColor);
    ...
    public static class Builder implements Serializable {
        ...
        @Nullable Parcelable[] colorsTop;
        @Nullable Parcelable[][] colorsSub;
        @Nullable String tag;
        ...
        @NonNull
        Builder preselect(Parcelable preselect) {
        ...
        @NonNull
        Builder accentMode(boolean accentMode) {
            this.accentMode = accentMode;
            return this;
        }

        @NonNull
        Builder doneButton(@StringRes int text) {
            doneBtn = text;
            return this;
        }

        @NonNull
        Builder backButton(@StringRes int text) {
            backBtn = text;
            return this;
        }

        @NonNull
        Builder cancelButton(@StringRes int text) {
            cancelBtn = text;
            return this;
        }
        ...
        @NonNull
        Builder customColors(@NonNull Parcelable[] topLevel, @Nullable Parcelable[][] subLevel) {
            colorsTop = topLevel;
            colorsSub = subLevel;
            return this;
        }
...
//        @NonNull
//        public Builder customColors(@ArrayRes Parcelable topLevel, @Nullable Parcelable[][] subLevel) {
...
//        }
        ...
        @NonNull
        Builder allowUserColorInput(boolean allow) {
    ...
    private class ColorGridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            Log.d("ColorChooserDialog", "getView: ");
            if (convertView == null) {
            ...
            if (isAccentMode())
                color = isInSub() ? ContextCompat.getColor(getContext(), ((AccentColor)colorsSub[topIndex()][position]).getAccentColorRes()) : ContextCompat.getColor(getContext(), ((AccentColor)colorsTop[position]).getAccentColorRes());
            else
                color = isInSub() ? ContextCompat.getColor(getContext(), ((PrimaryColor)colorsSub[topIndex()][position]).getPrimaryColorRes()) : ContextCompat.getColor(getContext(), ((PrimaryColor)colorsTop[position]).getPrimaryColorRes());

...
class FABAwareScrollingViewBehavior : AppBarLayout.ScrollingViewBehavior {
    ...
    override fun layoutDependsOn(
        ...
        return super.layoutDependsOn(
            ...
            child,
            dependency
        ) || dependency is FloatingActionButton || dependency is ExtendedFloatingActionButton
    }
    ...
    override fun onNestedScroll(
        ...
        if (dyConsumed > 0) {
            ...
            for (view in dependencies) {
                (view as? FloatingActionButton)?.hide(object :
                ...
                (view as? ExtendedFloatingActionButton)?.shrink()
            }

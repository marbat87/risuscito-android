...
/**
 * Created by marcello.battain on 04/02/2015.
 */
public class LinearProgress extends View {
    ...
    public LinearProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLineWidth = attributes.getDimensionPixelSize(R.styleable.LinearProgress_linear_progress_line_width,
                getResources().getDimensionPixelSize(R.dimen.linear_progress_line_width));
        mProgressMax = attributes.getInt(R.styleable.LinearProgress_linear_progress_max,
                getResources().getInteger(R.integer.linear_progress_max));
        attributes.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(0, getHeight() / 2, getWidth() * mProgress / 100, getHeight() / 2, topBarPaint);
    }

package it.cammino.utilities.showcaseview;
...
import it.cammino.utilities.showcaseview.actionbar.ActionBarViewWrapper;
import it.cammino.utilities.showcaseview.actionbar.reflection.BaseReflector;
import it.cammino.utilities.showcaseview.anim.AnimationUtils;
import it.cammino.utilities.showcaseview.anim.AnimationUtils.AnimationEndListener;
import it.cammino.utilities.showcaseview.anim.AnimationUtils.AnimationStartListener;
import it.cammino.utilities.showcaseview.drawing.ClingDrawer;
import it.cammino.utilities.showcaseview.drawing.ClingDrawerImpl;
import it.cammino.utilities.showcaseview.drawing.TextDrawer;
import it.cammino.utilities.showcaseview.drawing.TextDrawerImpl;
import it.cammino.utilities.showcaseview.targets.Target;
import it.cammino.utilities.showcaseview.utils.Calculator;
import it.cammino.utilities.showcaseview.utils.PointAnimator;
...
//        ConfigOptions options = new ConfigOptions();
     ...
     * @deprecated Use setShowcase with a {@link it.cammino.utilities.showcaseview.targets.ViewTarget}
     */
    @Deprecated
    ...
    /**
     * @deprecated This will soon become private. Use setShowcase with a {@link it.cammino.utilities.showcaseview.targets.PointTarget}
     */
    @Deprecated
...
//            mShowcaseDrawer.drawShowcase(canvas, showcaseX, showcaseY, scaleMultiplier, showcaseRadius);
     ...
     * @see it.cammino.utilities.showcaseview.ShowcaseView#animateGesture(float, float, float, float, boolean)
     */
...
//        public boolean block = true, noButton = false;
         ...
         * {@link it.cammino.utilities.showcaseview.ShowcaseView}).
         *
        ...
        /**
         * If you want to use more than one Showcase with the {@link it.cammino.utilities.showcaseview.ShowcaseView.ConfigOptions#shotType} {@link
         * it.cammino.utilities.showcaseview.ShowcaseView#TYPE_ONE_SHOT} in one Activity, set a unique value for every different
         * Showcase you want to use.
         */
        public int showcaseId = 0;

        /**
         * If you want to use more than one Showcase with {@link it.cammino.utilities.showcaseview.ShowcaseView#TYPE_ONE_SHOT} in one
         * Activity, set a unique {@link it.cammino.utilities.showcaseview.ShowcaseView.ConfigOptions#showcaseId} value for every different
         * Showcase you want to use. If you want to use this in the {@link ShowcaseViews} class, you
         * need to set a custom showcaseId for each {@link it.cammino.utilities.showcaseview.ShowcaseView}.
         */

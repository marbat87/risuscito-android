...
public class ShowcaseViews {
     ...
     * @see it.cammino.utilities.showcaseview.ShowcaseView#animateGesture(float, float, float, float)
     * @see it.cammino.utilities.showcaseview.ShowcaseViews#addAnimatedGestureToView(int, float, float, float, float, boolean)
     */
